  ...
  return (
     <div className='w-full h-full flex flex-col gap-3' >
                <div className='w-full h-56   '>
                    <img src={cover} alt=" caverimage" className='w-full rounded-t-2xl object-contain ' />
                    <img src={profile} alt="imgprofile " className=' w-40 h-40 rounded-full bottom-15 left-3 border-8 border-white relative ' />
                </div>
                <div>
